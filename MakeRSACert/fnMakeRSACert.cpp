...
static const char* kCertFile = "data\\ca.crt";
static const char* kPrivKeyFile = "data\\private.key";
static const char* kSerinalFile = "data\\serinal.txt";
...
MAKERSACERT_API DWORD fnMakeRSACertByP10(IN char* p10Base64Data, OUT char* pCertData, OUT long* lCertLen)
{
	...
	//addExt(&ctx, cert.get(), NID_ext_key_usage, "codeSigning");
	// self key id
	...
	ret = X509_sign(cert.get(), caPrivateKey.get(), EVP_sha256()/*EVP_sha1()*/);
	SHOULD_OPT_FAILED(ret);
